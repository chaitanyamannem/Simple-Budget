...
public class JDBCExpenseDAO implements ExpenseDAO {
	...
	public Expense insert(Expense expense) {
		...
		parameters.put(SBUDConstants.TABLE_COMMON_COLUMN_CATEGORY_ID, expense.getCategoryId());
	...
	public List<Expense> findAllExpensesByDate(Date onDate) {
		...
		String getExpensesByDateQuery = "SELECT * FROM EXPENSE WHERE SPENT_ON = ?;";
		List<Expense> expenses = this.jdbcTemplate.query(
				getExpensesByDateQuery, new Object[] { onDate },
				new int[] { Types.DATE }, new RowMapper<Expense>() {
					public Expense mapRow(ResultSet rs, int rowNum)
							throws SQLException {
						Expense expense = new Expense();
						expense.setId(rs
